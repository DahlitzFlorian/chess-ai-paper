...
\usepackage{graphicx,tabularx,xcolor,hyperref,scrlayer-scrpage,scrhack,listings,xurl,pdfpages,courier,anyfontsize,csquotes,fontspec}
...
\usepackage[breakable]{tcolorbox}    
    ...
    \usepackage[shortlabels,inline]{enumitem} % IRkernel/repr support (it uses the enumerate* environment)
    \setlist{nosep,style=sameline}
    \usepackage[normalem]{ulem} % ulem is needed to support strikethroughs (\sout)
                                % normalem makes italics be italics, not underlines
    \usepackage{mathrsfs}
    
    % settings from parent file
    \linespread{1.5}
